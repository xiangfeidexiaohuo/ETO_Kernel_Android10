...
static unsigned int default_efficient_freq_hp[] = {1766400, 2054400};
...
#define DEFAULT_HISPEED_FREQ_LP 1228800
#define DEFAULT_HISPEED_FREQ_HP 1574400
#define DEFAULT_HISPEED_FREQ_PR 1612800
 ...
 */
unsigned long schedhorizon_freq_util(int cpu, unsigned long util,
...
static unsigned long sugov_get_util(struct sugov_cpu *sg_cpu)
{
	...
	return schedhorizon_freq_util(sg_cpu->cpu, util, max, FREQUENCY_UTIL);
}
#endif
